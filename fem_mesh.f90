...
!*****************************************************************************80
!
! A lot of useful routines for fem mesh manipulation, sparse matrix definition 
! and allocation, report printing etc., mostly written by John Burkardt
! which were modified to be useful in our case. Because of that in some cases 
! descriptions of the routines are pertinent to triangular elements with single 
! DOF at nodes, whereas implementation is for quad4 or other elements.
!
!*****************************************************************************80
!
public 
